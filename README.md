...
- **Deployment is a product choice.** Install managed local components, use OpenAI-compatible services, internal
  endpoints, OpenAI, Azure OpenAI, Anthropic, or a local Codex CLI for minutes generation.
...
| Codex CLI               | Runs ephemerally with shell, apps, plugins and web search disabled.                   |
